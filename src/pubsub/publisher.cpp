...
// int Publisher<MsgT>::Publish(const std::string &topic, const std::string
// &event,
//                              const MsgT &data, int depth) {
...
// template <typename MsgT>
// int Publisher<MsgT>::Publish(const std::string &event, const MsgT &data,
//                              int depth) {
//   std::string data_str = data.serialize();
